...
- [[01-Books/clean-architecture/02-Chapters/ch-03-paradigm-overview|Попередній розділ: Огляд парадигм]]

## Пов'язані нотатки

- [[01-Books/clean-architecture/03-Concepts/functional-decomposition-needs-structured-programming#^clean-architecture-functional-decomposition-definition|Локальний концепт про декомпозицію]]
